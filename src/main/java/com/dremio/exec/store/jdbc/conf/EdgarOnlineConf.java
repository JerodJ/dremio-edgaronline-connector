...
@SourceType(value = "EdgarOnlineARP", label = "EdgarOnline",uiConfig = "edgaronline-layout.json")
public class EdgarOnlineConf extends AbstractArpConf<EdgarOnlineConf> {
  private static final String ARP_FILENAME = "arp/implementation/edgaronline-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.edgaronline.EdgarOnlineDriver";
